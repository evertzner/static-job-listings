...
const Job = ({ job }) => {
  ...
  return (
    <div className={`job${isFeatured ? ' isFeatured' : ''}`}>
      <div className="job__info">
        ...
        <div className="job__info__details">
          <div className="job__info__details--header">
            ...
            {isNew && <div className="job__info__details--header__new-tag">NEW!</div>}
            {isFeatured && <div className="job__info__details--header__featured-tag">FEATURED</div>}
          </div>
      ...
      <div className="job__tags">{tags && tags.map((tag) => <Tag key={tag} tag={tag} />)}</div>
    </div>
  );
};
